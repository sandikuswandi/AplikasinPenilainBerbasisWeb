...
('Insert data ke tabel siswa, nisn = ', '2020-04-18 11:50:33', 'root@localhost', '', ''),
('Delete data ke tabel siswa, nisn = ', '2020-04-18 11:50:41', 'root@localhost', '', ''),
('Insert data ke tabel siswa, nisn = 102', '2020-04-18 14:21:50', 'root@localhost', '', 'Hermawan'),
('Update data ke tabel siswa, nisn = 102', '2020-04-18 14:22:16', 'root@localhost', 'Hermawan', 'Hermawan'),
('Delete data ke tabel siswa, nisn = 102', '2020-04-18 14:22:41', 'root@localhost', 'Hermawan', ''),
('Insert data ke tabel siswa, nisn = s1', '2020-04-18 14:23:39', 'root@localhost', '', 'Dian'),
('Insert data ke tabel siswa, nisn = ', '2020-04-18 14:24:46', 'root@localhost', '', ''),
('Delete data ke tabel siswa, nisn = 1002', '2020-04-18 14:25:48', 'root@localhost', 'Ferdiansyahssd', ''),
('Insert data ke tabel siswa, nisn = 1021', '2020-04-18 14:26:50', 'root@localhost', '', 'Gilang'),
('Delete data ke tabel siswa, nisn = ', '2020-04-18 14:28:20', 'root@localhost', '', ''),
('Delete data ke tabel siswa, nisn = 1004', '2020-04-18 14:28:20', 'root@localhost', 'Fauzan', ''),
('Delete data ke tabel siswa, nisn = 1006', '2020-04-18 14:28:21', 'root@localhost', 'Aldova', ''),
('Delete data ke tabel siswa, nisn = 1021', '2020-04-18 14:28:22', 'root@localhost', 'Gilang', ''),
('Delete data ke tabel siswa, nisn = s1', '2020-04-18 14:28:22', 'root@localhost', 'Dian', ''),
('Update data ke tabel siswa, nisn = S122', '2020-04-18 14:33:08', 'root@localhost', 'Dudi', 'Dudi'),
('Update data ke tabel siswa, nisn = S122', '2020-04-18 14:35:08', 'root@localhost', 'Dudi', 'Dudi'),
('Update data ke tabel siswa, nisn = S122', '2020-04-18 14:38:19', 'root@localhost', 'Dudi', 'Rendi'),
('Delete data ke tabel siswa, nisn = S122', '2020-04-18 14:39:20', 'root@localhost', 'Rendi', ''),
('Insert data ke tabel siswa, nisn = zx', '2020-04-18 14:47:47', 'root@localhost', '', 'sd'),
('Delete data ke tabel siswa, nisn = zx', '2020-04-18 14:47:52', 'root@localhost', 'sd', ''),
('Insert data ke tabel siswa, nisn = 181920', '2020-04-22 01:05:08', 'root@localhost', '', 'Aldi'),
('Update data ke tabel siswa, nisn = 181920', '2020-04-22 01:05:23', 'root@localhost', 'Aldi', 'Aldi ardiansyah'),
('Delete data ke tabel siswa, nisn = 181920', '2020-04-22 01:05:36', 'root@localhost', 'Aldi ardiansyah', ''),
('Insert data ke tabel siswa, nisn = 181821', '2020-04-22 01:15:18', 'root@localhost', '', 'Aldi ardiansyah'),
('Update data ke tabel siswa, nisn = 181821', '2020-04-23 01:42:41', 'root@localhost', 'Aldi ardiansyah', 'Aldi ardiansya'),
('Update data ke tabel siswa, nisn = 181821', '2020-04-23 01:43:08', 'root@localhost', 'Aldi ardiansya', 'Aldi ');
...
(20, '22', '12', '12', 'F', 'sunda', 'X TKJ C'),
(21, '80', '80', '80', 'dedi', 'PKK', 'X RPL C'),
(26, '32', '32', '32', 'Black Box', 'as', 'X TKJ C');
...
('181821', 'Aldi ', 'Cimindi', 'perempuan', 'Kimia', 'XI RPL C');
...
--
ALTER TABLE `nilai`
  MODIFY `id_nilai` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
