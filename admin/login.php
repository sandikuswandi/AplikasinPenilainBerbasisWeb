	...
	<div class="web-login">
		...
		<div class="box-login">
			<form action="ceklogin.php" method="post" class="login-form">
				...
				<input type="text" name="username" placeholder="Username .." required="required" class="input-lgn">
				<label class="lgn-label">Password</label>
				<input type="password" name="password" placeholder="Password .." required="required" class="input-lgn">
